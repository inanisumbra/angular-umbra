...
* Social logins support with token based authentication, Follow [this](https://github.com/inanisumbra/angular-umbra/wiki/Social-Login-Setup) wiki page to see how it will work.
...
```
1. Clone the repo
    git clone https://github.com/inanisumbra/angular-umbra
2. Change directory
    cd AngularUmbra
3. Run Server
    dotnet build AngularUmbra.sln
