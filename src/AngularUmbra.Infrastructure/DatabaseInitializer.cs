...
namespace AngularUmbra.Infrastructure
{
  ...
  public class DatabaseInitializer : IDatabaseInitializer
  {
        ...
        _context.Cultures.AddRange(
            new Culture
            {
              ...
              Resources = new List<Resource>() {
                            new Resource { Key = "app_title", Value = "AngularUmbra" },
                            new Resource { Key = "app_description", Value = "Demo app using ASP.NET and Angular 6" },
                            new Resource { Key = "app_repo_url", Value = "https://github.com/like-a-fox/AngularUmbra" },
    ...
    {
      if (await _openIddictApplicationManager.FindByClientIdAsync("AngularUmbra") == null)
      {
        var host = configuration["HostUrl"].ToString();

        var descriptor = new OpenIddictApplicationDescriptor
        {
          ClientId = "AngularUmbra",
          DisplayName = "AngularUmbra",
