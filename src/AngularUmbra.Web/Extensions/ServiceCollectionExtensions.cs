...
using AngularUmbra.Infrastructure;

namespace AngularUmbra.Web.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddCustomDbContext(this IServiceCollection services)
        {
            ...
            services.AddDbContextPool<ApplicationDbContext>(options =>
            {
                ...
                {
                    options.UseInMemoryDatabase("AngularUmbra"); // Takes database name
                }
                else if (useSqLite.ToLower() == "true")
                {
                    var connection = Startup.Configuration["Data:SqlLiteConnectionString"];
                    options.UseSqlite(connection);
                    options.UseSqlite(connection, b => b.MigrationsAssembly("AngularUmbra.Web"));
                ...
                else
                {
                    ...
                    options.UseSqlServer(connection, b => b.MigrationsAssembly("AngularUmbra.Web"));
                }
