using AngularUmbra.Web.Extensions;
using AngularUmbra.Web.SignalR;
using AngularUmbra.Core.ViewModels;
using AutoMapper;
...
namespace AngularUmbra.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                configuration.RootPath = "ClientApp/dist/AngularUmbra";
            });

            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new Info { Title = "AngularUmbra", Version = "v1" });
            ...
            app.UseSpa(spa =>
                      {
                          ...
                          // [1] In AngularUmbra.csproj, change the <BuildServerSideRenderer> property
